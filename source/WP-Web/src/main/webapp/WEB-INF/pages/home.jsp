...
<link rel="stylesheet" href="resources/css/fonts/stylesheet.css" />
<link rel="stylesheet" href="resources/css/fonts/fonts.css" />
<link rel="stylesheet" href="resources/css/bootstrap/bootstrap.min.css" />
<link rel="stylesheet" href="resources/css/animat/animate.min.css" />
<link rel="stylesheet" href="resources/css/fancybox/jquery.fancybox.css" />
<link rel="stylesheet"
	href="resources/css/nivo-lightbox/nivo-lightbox.css" />
<link rel="stylesheet" href="resources/css/themes/default/default.css" />
<link rel="stylesheet"
	href="resources/css/owl-carousel/owl.carousel.css" />
<link rel="stylesheet" href="resources/css/owl-carousel/owl.theme.css" />
<link rel="stylesheet"
	href="resources/css/owl-carousel/owl.transitions.css">
				...
				<div class="main_abouts_content">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="single_abouts wow fadeInRight" data-wow-duration="1s">
							<img src="resources/images/ab.jpg" alt="" />
						</div>
					</div>
				</div>
			</div>
		...
		<div class="main_featured_content">
			<div class="col-md-4 col-sm-6 col-xs-12 single_featured_area">
				<div class="single_featured wow fadeIn" data-wow-duration=".5s">
					<img src="resources/images/f1.jpg" alt="" />
			...
			<div class="col-md-4 col-sm-6 col-xs-12 single_featured_area">
				<div class="single_featured wow fadeIn" data-wow-duration=".5s">
					<img src="resources/images/f2.jpg" alt="" />
					<div class="featured_overlay">
						<div class="overlay_content">
							<a href="" class="btn btn-white">VIEW DEATIL</a>
						</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12 single_featured_area">
				<div class="single_featured wow fadeIn" data-wow-duration=".5s">
					<img src="resources/images/f3.jpg" alt="" />
					<div class="featured_overlay">
						<div class="overlay_content">
							<a href="" class="btn btn-white">VIEW DEATIL</a>
						</div>
				...
				<div class="main_team_content text-center">
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_team wow fadeIn" data-wow-duration="1.5s">
							<div class="single_team_img">
								<img src="resources/images/tm1.jpg" alt="" />
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_team wow fadeIn" data-wow-duration="2s">
							<div class="single_team_img">
								<img src="resources/images/tm2.jpg" alt="" />
								<div class="single_team_overlay text-center">
									<p>Hi ! I m Redwan from bangladesh.I am a Professional graphic designer & expert on print and UI/ UX .</p>
									<a href=""><i class="fa fa-facebook"></i></a>
									<a href=""><i class="fa fa-linkedin"></i></a>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_team wow fadeIn" data-wow-duration="2.5s">
							<div class="single_team_img">
								<img src="resources/images/tm3.jpg" alt="" />
								<div class="single_team_overlay text-center">
									<p>Hi ! I m Redwan from bangladesh.I am a Professional graphic designer & expert on print and UI/ UX .</p>
									<a href=""><i class="fa fa-facebook"></i></a>
									<a href=""><i class="fa fa-linkedin"></i></a>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
						<div class="single_team wow fadeIn" data-wow-duration="2.8s">
							<div class="single_team_img">
								<img src="resources/images/tm4.jpg" alt="" />
								<div class="single_team_overlay text-center">
									<p>Hi ! I m Redwan from bangladesh.I am a Professional graphic designer & expert on print and UI/ UX .</p>
									<a href=""><i class="fa fa-facebook"></i></a>
									<a href=""><i class="fa fa-linkedin"></i></a>
					...
					<div class="main_testimonial text-center wow fadeIn" data-wow-duration="1s">
						<div class="single_testimonial">
							<div class="single_testimonial_img">
								<img class="img-circle" src="resources/images/tst1.jpg" alt="" />
...
<script type="text/javascript"
	src="resources/js/fancybox/jquery.fancybox.pack.js"></script>

<script type="text/javascript"
	src="resources/js/nivo-lightbox/nivo-lightbox.min.js"></script>

<script type="text/javascript"
	src="resources/js/owl-carousel/owl.carousel.min.js"></script>

<script type="text/javascript"
	src="resources/js/jquery-easing/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="resources/js/wow/wow.min.js"></script>

<script type="text/javascript" src="resources/js/isotop/isotope.min.js"></script>
<script type="text/javascript"
	src="resources/js/isotop/isotop.function.js"></script>

<script type="text/javascript" src="resources/js/masonry/masonry.min.js"></script>

<script type="text/javascript"
	src="resources/js/mixitup/jquery.mixitup.min.js"></script>
<script type="text/javascript"
	src="resources/js/masonry/masonry.pkgd.min.js"></script>
</body>
</html>
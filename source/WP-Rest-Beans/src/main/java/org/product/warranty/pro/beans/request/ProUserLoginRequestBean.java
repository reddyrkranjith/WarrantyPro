...
import org.product.warranty.pro.beans.custom.validations.CheckAtLeastOneNotNull;
import org.product.warranty.pro.beans.custom.validations.ValidPassword;

@CheckAtLeastOneNotNull(fieldNames={"username","email"})
public class ProUserLoginRequestBean implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 1701594761900078746L;
